...
export function SportPage({
  ...
  const isTrainingTypeFilterActive = trainerFilters.trainingType !== null;
  const hasActiveTrainerFilters = isTrainerCategoryFilterActive || isCityFilterActive || isRatingFilterActive || isTrainerPriceFilterActive || isTrainingTypeFilterActive || trainerFilters.quickFilter;
  ...
  const hasActiveProgramFilters = isCategoryFilterActive || isLevelFilterActive || isDurationFilterActive || isProgramRatingFilterActive || isProgramPriceFilterActive;
            ...
            <div className="mb-6 flex flex-col sm:flex-row gap-4 justify-between items-start sm:items-center">
              ...
              <div className="flex items-center gap-3">
                ...
                <Button
                  ...
                  className={showFilters ? 'bg-brand/10 text-brand border-brand/20' : ''}
                >
                  <Filter className="h-4 w-4 mr-2" />
                  Filtros
                  {getActiveFiltersCount() > 0 && (
                    <Badge variant="secondary" className="ml-2 bg-brand text-brand-foreground">
