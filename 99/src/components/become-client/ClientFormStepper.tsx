...
const steps = [
  ...
  },
  {
    step: 2,
    title: "Objetivos",
    description: "Suas metas fitness"
  },
  {
    step: 3,
    title: "Atividade",
  ...
  },
  {
    step: 4,
    title: "Preferências",
    description: "Como gosta de treinar"
  },
  {
    step: 5,
    title: "Localização",
    description: "Onde quer treinar"
  },
  {
    step: 6,
    title: "Finalização",
...
export function ClientFormStepper({ currentStep, onStepChange }: ClientFormStepperProps) {
  return (
