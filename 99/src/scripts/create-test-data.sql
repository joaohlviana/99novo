-- =============================================
-- CRIAR DADOS DE TESTE - SISTEMA UNIFICADO
-- =============================================
-- 
-- Este script cria dados básicos para testar o sistema após
-- a correção das permissões e implementação da estrutura SQL
--
-- =============================================
